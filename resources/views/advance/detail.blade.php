	...
	<main class="content">
		...
		<div class="container-fluid">
			...
			<div class="header">
				...
				<p class="header-subtitle">A-{{ $advance->id }}</p>
			</div>

			<div class="row">
				<div class="col-xl-6 col-xxl-7">
					<div class="card flex-fill w-100">
                        gold amount: {{ $advance->gold_amount }} <br>
                        fiat leased: {{ $advance->fiat_leased }} <br>
                        interest: {{ $advance->interest }} <br>
                        currency: {{ $advance->currency }} <br>
                        status: {{ $advance->status }} <br>
                        created: {{ $advance->created_at }} <br>

                        <br>

                        billplz_id: {{ $pay_out->id }} <br>
                        amount: {{ $pay_out->amount }} <br>
                        currency: {{ $pay_out->currency }} <br>
                        method: {{ $pay_out->method }} <br>
                        status: {{ $pay_out->status }} <br>
                        note_1: {{ $pay_out->note_1 }} <br>
                        note_2: {{ $pay_out->note_2 }} <br>
                        note_3: {{ $pay_out->note_3 }} <br>
                        created_at: {{ $pay_out->created_at }} <br>
