            ...
            <div class="row">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="/blockchain/mint">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label">Gold Amount, gram</label>
                                    <input type="number" class="form-control" name="amount" value=0.1 step="0.1"
                                        min=0.1>
                                </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                @foreach ($mints as $mint)
                                    <tr>
                                        <td><a href="/app/blockchain/mint/{{ $mint->id }}">BCM-{{ $mint->id }}</a>
                                        </td>
