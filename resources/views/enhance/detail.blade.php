	...
	<main class="content">
		...
		<div class="container-fluid">
			...
			<div class="header">
				...
				<p class="header-subtitle">A-{{ $enhance->id }}</p>
			</div>

			<div class="row">
				<div class="col-xl-6 col-xxl-7">
					<div class="card flex-fill w-100">
                        gold amount: {{ $enhance->amount }} <br>
                        multiplier: {{ $enhance->leverage }} <br>
                        capital: {{ $enhance->capital }} <br>
                        facility: {{ $enhance->loan }} <br>
                        interest: {{ $enhance->interest }} <br>
                        currency: {{ $enhance->currency }} <br>
                        status: {{ $enhance->status }} <br>
                        created: {{ $enhance->created_at }} <br>

                        <br>

                        billplz_id: {{ $pay_in->id }} <br>
                        amount: {{ $pay_in->amount }} <br>
                        currency: {{ $pay_in->currency }} <br>
                        method: {{ $pay_in->method }} <br>
                        status: {{ $pay_in->status }} <br>
                        note_1: {{ $pay_in->note_1 }} <br>
                        note_2: {{ $pay_in->note_2 }} <br>
                        note_3: {{ $pay_in->note_3 }} <br>
                        created_at: {{ $pay_in->created_at }} <br>
