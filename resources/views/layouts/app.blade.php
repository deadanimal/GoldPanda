                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="/pro">
                            <i class="align-middle me-2 fas fa-fw fa-university"></i> <span
                                class="align-middle">Trade</span>
                        </a>
                    </li>
        ...
        <div class="main">
            ...
            @if ($errors->any())
                ...
                @foreach ($errors->all() as $error)
                    <div class="modal fade show" id="modalText" style="display: block;" aria-modal="true"
                        role="dialog">
