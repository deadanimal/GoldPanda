	...
	<main class="content">
		...
		<div class="container-fluid">
			...
			<div class="header">
				...
				<p class="header-subtitle">B-{{ $bought->id }}</p>
			</div>

			<div class="row">
				<div class="col-xl-6 col-xxl-7">
					<div class="card flex-fill w-100">
                        gold amount: {{ $bought->gold_amount }} <br>
                        fiat flow: {{ $bought->fiat_inflow }} <br>
                        currency: {{ $bought->currency }} <br>
                        status: {{ $bought->status }} <br>
                        created: {{ $bought->created_at }} <br>
