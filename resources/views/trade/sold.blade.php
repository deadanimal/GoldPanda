	...
	<main class="content">
		...
		<div class="container-fluid">
			...
			<div class="header">
				...
				<p class="header-subtitle">S-{{ $sold->id }}</p>
			</div>

			<div class="row">
				<div class="col-xl-6 col-xxl-7">
					<div class="card flex-fill w-100">
                        gold amount: {{ $sold->gold_amount }} <br>
                        fiat flow: {{ $sold->fiat_outflow }} <br>
                        currency: {{ $sold->currency }} <br>
                        status: {{ $sold->status }} <br>
                        created: {{ $sold->created_at }} <br>
